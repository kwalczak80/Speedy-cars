...
class Car(models.Model):
    ...
    body_type = models.CharField(max_length=50, choices=BODY_TYPE,
                                 default=BODY_TYPE[0][0])
    ...
    engine_size = models.CharField(max_length=20, choices=ENGINE_SIZE,
                                   default=ENGINE_SIZE[0][0])
